...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("blockhash", make_shared<FunctionType>(strings{"bytes32"}, strings{"bytes32"}, FunctionType::Kind::BlockHash, false, StateMutability::View)),
